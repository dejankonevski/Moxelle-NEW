      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex gap-4 md:gap-5 items-start">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="flex items-center gap-1.5 text-[11px] font-mono text-brand-neutralgray">
                  ...
                  {/* UNIFIED PREMIUM ENGAGEMENT BADGE */}
                  <div className="flex items-center gap-1.5 border-y border-neutral-100 py-2.5">
                    <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                    <span className="text-[10px] font-mono font-bold text-brand-navy">
                      Engagement Status: <span className="text-brand-teal">Open for Project Allocations &amp; Sprints</span>
                    </span>
                  </div>
                  ...
                  <div className="bg-white border border-neutral-200/80 rounded-2xl p-4 space-y-2 relative shadow-3xs">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-mono text-[9px] text-brand-teal uppercase tracking-wider font-extrabold block">
        ...
        <div className="mt-16 text-center max-w-xl mx-auto space-y-4">
          <p className="text-xs text-brand-neutralgray leading-relaxed">
            Need specialized roles or alternative tech configurations (e.g., Rust, Kubernetes, Salesforce)? We maintain active talent benches globally to build your customized engineering hub in under 21 days.
          </p>
          <button
